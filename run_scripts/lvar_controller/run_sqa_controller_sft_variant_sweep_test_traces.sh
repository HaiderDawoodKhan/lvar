...
OUTPUT_ROOT="${OUTPUT_ROOT:-outputs/controller_sft_sqa_test_sweeps}"
TRAIN_ROOT="${TRAIN_ROOT:-${OUTPUT_ROOT}/train}"
MANIFEST_PATH="${MANIFEST_PATH:-${OUTPUT_ROOT}/controller_runs.jsonl}"
GLOBAL_TRACE_PATH="${GLOBAL_TRACE_PATH:-outputs/oracle_dataset/sqa/test/lvar_ckpt/sqa_test_traces_lvar_global.jsonl}"
