...
eval_mined_trace_setting() {
  ...
  local inference_dir="outputs/inference/validation_oracle_boosted/mined_by_${mined_by_key}_ckpt/evaluated_by_${evaluated_by_key}_ckpt/trace_variant_raw/target_${target}/layers_${layer_mode}/alpha_${alpha}"
